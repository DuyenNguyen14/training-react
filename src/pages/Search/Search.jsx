...
export default function Search() {
  ...
  const handleChange = (e) => {
    // Bước 4: Khi người dùng gõ phím trên thanh search thì lấy ra giá trị value gắn vào thay url
    const { value } = e.target;
    // setKeyword(value);

    // Khi người dùng gõ phím thì setSearchParams thực thi --> function được render lại để kích hoạt useEffect chạy
    setSearchParams({
  ...
  const getProductByKeywordApi = async () => {
    // call api (b2 --> gọi api sau lần đầu tiền load trang)
    try {
