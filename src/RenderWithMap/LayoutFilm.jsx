...
export default class LayoutFilm extends Component {
    renderFilmCard = () => {
        return DATA.map((film, index) => {
            return <div className="col-2" key={index}>
                <div className="card bg-dark" style={{ maxHeight: '480px' }}>
                    <img src={film.hinhAnh} alt="..." />
                    <div className="card-body text-light">
                        <h5>{film.tenPhim}</h5>
                        <p style={{ fontSize: '13px' }}>{film.moTa}</p>
                    </div>
                </div>
            </div>
        })
    ...
    render() {
        return (
            <div style={{ background: 'url("./img/avanger.jpg")', backgroundSize: "100%", backgroundPosition: "right bottom", minHeight: '100vh' }}>
                {/* Navbar */}
                <nav className="navbar navbar-expand-sm navbar-dark bg-dark px-4" style={{ opacity: '.7' }}>
                ...
                {/* End of Navbar */}
                {/* Content */}
                <div className="row mt-5 px-4 py-5">
                    {/* <div className="col-2">
                        <div className="card bg-dark">
                            <img src={DATA[0].hinhAnh} alt="..." />
                            <div className="card-body text-light">
                                <h5>{DATA[0].tenPhim}</h5>
                                <p style={{ fontSize: '13px' }}>{DATA[0].moTa}</p>
                            </div>
                        </div>
                    </div> */}
                    {this.renderFilmCard()}
