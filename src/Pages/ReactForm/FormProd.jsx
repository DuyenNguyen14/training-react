...
export default class FormProd extends Component {
    ...
    state = {
        productInfo: { // thuộc tính của state là 1 object
            id: '',
            name: '',
            price: '',
            img: '',
                    ...
                    <div className="row">
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input id='id' type="text" className="form-control" placeholder='product id' onInput={this.handleChange} />
                                <p className="text-danger">{this.state.error.id}</p>
                            </div>
                            <div className="form-group my-3">
                                <p className='my-0'>name</p>
                                <input id='name' type="text" className="form-control" placeholder='product name' onInput={this.handleChange} />
                            ...
                            <div className="form-group">
                                 ...
                                 */}
                                <input data-type="number" id='price' type="text" className="form-control" placeholder='product price' onInput={this.handleChange} />
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input id='img' type="text" className="form-control" placeholder='product image' onInput={this.handleChange} />
                                <p className="text-danger">{this.state.error.img}</p>
                            </div>
                            <div className="form-group my-3">
                                <p className='my-0'>product type</p>
                                <select id="type" className="form-control" onInput={this.handleChange}>
                            ...
                            <div className="form-group">
                                ...
                                <textarea id="description" className="form-control" placeholder='product description' onInput={this.handleChange}></textarea>
